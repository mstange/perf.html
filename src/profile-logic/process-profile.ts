 ...
 * the function additionally gets a "resource" of type ResourceType.Library, which names
 * the library but does not identify it.
 * We return the index of the newly-added function, the library, and the address as a

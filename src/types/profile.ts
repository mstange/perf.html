...
export type RawFrameTable = {
  ...
  // The native library that this frame's code is in. Only meaningful when
  // `HasLib` is set in `flags`; frames which aren't native code (JS frames,
  // label frames) or whose library is unknown leave `HasLib` unset.
  //
  ...
  lib: Array<IndexIntoLibs> | Int32Array<ArrayBuffer>;
